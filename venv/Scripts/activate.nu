...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ASUS\PythonProjects\Blog_project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ASUS\PythonProjects\Blog_project\venv\Scripts\deactivate.nu'
